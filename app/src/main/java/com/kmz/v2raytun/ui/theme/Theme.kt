 ...
 *
 * On Android 12+ we defer to the wallpaper-derived [dynamicLightColorScheme]/
 * [dynamicDarkColorScheme] so the app blends with the user's system palette; older
 * releases get the hand-tuned brand scheme above. [dynamicColor] can be turned off to
 * force the brand scheme (useful for previews and screenshots).
 */
@Composable
fun V2RayTunTheme(
